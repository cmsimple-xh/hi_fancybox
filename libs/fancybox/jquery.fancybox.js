/*
 * @version $Id: jquery.fancybox.js 26 2017-04-29 22:19:47Z hi $
 *
 */
/*
 ...
 * 
 * (2017-04-29) Modified 2017 Holger Irmler Bugfix ($browser and .load() in Iframe)
 * 
...
(function ($) {
    var tmp, loading, overlay, wrap, outer, content, close, title, nav_left, nav_right,
            ...
            _start = function () {
                ...
                if (selectedOpts.titlePosition != 'over') {
                    selectedOpts.margin += 35;
                }
            ...
            _show = function () {
                ...
                if (wrap.is(":visible") && currentOpts.titlePosition !== 'float') {
            ...
            _finish = function () {
                ...
                if (currentOpts.type == 'iframe') {
                    ...
                    $('<iframe id="fancybox-frame" name="fancybox-frame' + new Date().getTime() + '" frameborder="0" hspace="0" ' + ' allowTransparency="true"' + ' scrolling="' + selectedOpts.scrolling + '" src="' + currentOpts.href + '"></iframe>').appendTo(content).on('load', function () {
                        if (selectedOpts && selectedOpts.showIframeLoading) {
    ...
    $.fancybox.init = function () {
        ...
        nav_left.click(function (e) {
            e.preventDefault();
            $.fancybox.prev();
            //HI Fix for sticky hover nav-button on touch-devices
            var el = $('a#fancybox-left');
            el.detach();
            setTimeout(function () {
                el.insertBefore($('a#fancybox-right'));
            }, 0);
        });
        ...
        nav_right.click(function (e) {
            ...
            $.fancybox.next();
            //HI Fix for sticky hover nav-button on touch-devices
            var el = $('a#fancybox-right');
            el.detach();
            setTimeout(function () {
                el.insertAfter($('a#fancybox-left'));
            }, 0);
        });
    ...
    $.fn.fancybox.defaults = {
        ...
        overlayColor: '#777',
        titleShow: true,
        titlePosition: 'float', // 'float', 'inside' or 'over' -- 'outside' is removed in this fork
        titleFormat: null,
        titleFromAlt: false,
